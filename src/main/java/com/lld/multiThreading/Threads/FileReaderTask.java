...
/*
What is the purpose of the Future interface in Java? isDone() [non-blocking] , get() [blocking] , cancel()
How does the Callable interface differ from the Runnable interface in Java?
What is the role of the submit() method in ExecutorService, and how does it relate to Callable? || submit takes callable or runnable and return future
...
How would you ensure that a task submitted to ExecutorService completes successfully before moving on to the next task? use future.get() or execService.invokeAll(tasks) [take list of callable task];
